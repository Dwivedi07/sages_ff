...
def for_computation(input_iterable):
    ...
    if sol_cvx['status'] in ['optimal', 'optimal_inaccurate']:
        ...
        oe_cvx = dyn.propagate_oe(prob.oe_i, prob.tvec_sec)
        states_rtn_cvx_i = roe_to_rtn(states_roe_cvx_i, oe_cvx)  # Transpose back to (n_time, 6)
...
if __name__ == '__main__':
    ...
    num_processes = 25
    N_data = 100  # number of data to try warm-start analysis 
