...
(1) For each test sample in the test dataset, we will run the ART LANG Decision Transformer to get warm start then feed it to the nominal SCP solver.
(2) For each test sample in the test dataset, we will also run the exact SCP Solver
